...
// Manage therapist profiles (table: therapists)
...
// Manage therapy processes (catalog of exercises/procedures)
...
// Assign therapist to patient by updating therapists.user_list JSON with patient_id
